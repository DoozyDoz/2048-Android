package com.gameditors.a2048.utils;
...
public class AdController {
    ...
    public static int adDisplayCounter = 14;
...
//        InterstitialAd.load(context,context.getString(R.string.admob_test_inter), adRequest, new InterstitialAdLoadCallback() {
            @Override
